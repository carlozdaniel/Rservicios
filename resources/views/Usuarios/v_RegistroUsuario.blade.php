                    ...
                    <form method="POST" action="{{ route('registro.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="tipo" id="tipo" class="form-control @error('tipo') is-invalid @enderror" required autocomplete="tipo" autofocus >
                        ...
                        <div class="form-group row">
                            <label for="colonia" class="col-md-4 col-form-label text-md-right">{{ __('Calle') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="colonia" class="col-md-4 col-form-label text-md-right">{{ __('Codigo postal') }}</label>
